...
TWITTER_API_KEY = os.getenv("TWITTER_API_KEY", "gorbagana")
TWITTER_API_SECRET = os.getenv("TWITTER_API_SECRET", "gorbagana")
TWITTER_ACCESS_TOKEN = os.getenv("TWITTER_ACCESS_TOKEN", "gorbagana")
TWITTER_ACCESS_TOKEN_SECRET = os.getenv("TWITTER_ACCESS_TOKEN_SECRET", "gorbagana")
TWITTER_BEARER_TOKEN = os.getenv("TWITTER_BEARER_TOKEN", "gorbagana")

AIRTABLE_API_KEY = os.getenv("AIRTABLE_API_KEY", "gorbagana")
AIRTABLE_BASE_KEY = os.getenv("AIRTABLE_BASE_KEY", "gorbagana")
AIRTABLE_TABLE_NAME = os.getenv("AIRTABLE_TABLE_NAME", "gorbagana")

OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "gorbagana")
...
class TwitterBot:
    ...
    def execute_replies(self):
        print (f"Starting gorbagana job: {datetime.utcnow().isoformat()}")
        self.respond_to_mentions()
        print (f"Finished gorbagana job: {datetime.utcnow().isoformat()}, Found: {self.mentions_found}, Replied: {self.mentions_replied}, Errors: {self.mentions_replied_errors}")

# The job that we'll schedule to run every X minutes
def job():
    print(f"gorbagana job executed at {datetime.utcnow().isoformat()}")
    bot = TwitterBot()
    bot.execute_replies()
